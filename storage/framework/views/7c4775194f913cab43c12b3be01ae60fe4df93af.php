            ...
            <div style="padding-bottom: 15px">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <a href="<?php echo e(asset('/')); ?>nuevanotaventa" class="btn btn-sm btn-primary">Crear Nota de Venta</a>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-2">
                    ...
                    <?php $__currentLoopData = $listaNotasdeVenta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td style="width:80px; text-align: right">
                               <b> <?php echo e($item->CantidadNotaVenta - $item->CantidadPedidos); ?> </b>
                            </td>
                            <td>
                                <?php if($item->aprobada==1 and Session::get('grupoUsuario')=='C'): ?>
