...
<div style="padding: 20px">
    <div class="panel panel-default table-responsive">
        ...
        <div class="panel-heading">
            <b>Productos</b>
            <span class="badge badge-info pull-right"><?php echo e($listaProductos->count()); ?> Productos</span>
        </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $listaProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($item->prod_descripcion); ?></td>
                            <td><?php echo e($item->prod_estado); ?></td>
                            <td style="text-align: center;">
                                <?php if($item->prod_visible==1): ?>
                                    SI
                                <?php else: ?>
                                    NO
                                <?php endif; ?>
                            </td>
                            <td style="text-align: right;"><?php echo e(number_format( $item->precio_referencia, 0, ',', '.' )); ?></td>
                            <td style="text-align: center;">
