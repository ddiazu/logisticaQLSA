						...
						<?php if( Session::get('idPerfil')!='13' ): ?>
							...
							<li class="openable open">
								...
								<ul class="submenu">
									...
									<?php elseif( Session::get('idPerfil')=='9' ): ?>
										<li><a href="<?php echo e(asset('/')); ?>guiasEnProceso"><span class="submenu-label">Guías en Proceso</span></a></li>
									<?php else: ?>
										<li><a href="<?php echo e(asset('/')); ?>listarNotasdeVenta"><span class="submenu-label">Notas de Venta</span></a></li>
							...
							<li class="openable open">
								...
								<ul class="submenu">
									...
									<li><a href="<?php echo e(asset('/')); ?>historicoPedidos""><span class="submenu-label">Histórico de Pedidos</span></a></li>
								</ul>								
							</li>
						    <?php if( Session::get('grupoUsuario')!='CL' ): ?>
							<li class="openable open">
								...
								<ul class="submenu">
									...
									<li><a href="<?php echo e(asset('/')); ?>listadeObras"><span class="submenu-label">Obras</span></a></li>
									<li><a href="<?php echo e(asset('/')); ?>listaPlantas"><span class="submenu-label">Plantas</span></a></li>
									...
									<li><a href="#"><span class="submenu-label">Parámetros</span></a></li>					
								</ul>
							</li>
							<?php endif; ?>
						<?php else: ?>
