    ...
    public function cotizacionProductos(Request $datos){
        if( $datos->ajax() ){
            $resultado = DB::table('cotizaciones_productos')
                        ...
                        ->select('cotizaciones_productos.prod_codigo', 'cotizaciones_productos.cp_glosa_reajuste', 'productos.prod_nombre', 'unidades.u_nombre', 'cotizaciones_productos.cp_cantidad', 'cotizaciones_productos.cp_precio', 'productos.requiere_diseno')
