                ...
                <table id="tablaAprobados" class="table table-condensed" style="width: 100%">
                    ...
                    <tbody>
                        @foreach($guias as $item)
                            <tr>                                    
                                <td style="width:100px">{{ $item->numeroGuia }}</td>
                                ...
                                <td style="width:80px">
                                    @if( $item->certificado=='' )
                                        <button class="btn btn-warning btn-sm" onclick="abrirModalSubirArchivo(this.parentNode.parentNode.rowIndex, 1, {{ $item->prod_codigo }} );"><span class="glyphicon glyphicon-arrow-up"></span></button>
                                    @else
