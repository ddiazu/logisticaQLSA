                        ...
                        <div class="col-md-2">
                            <select  id="listaFormaEntrega" class="form-control input-sm">
                                @foreach($FormasdeEntrega as $formaEntrega)
                                    <option value="{{ $formaEntrega->idFormaEntrega }}">{{ $formaEntrega->nombre }}
                                @endforeach 
                            </select>  
                        </div>
                            ...
                            @foreach($NotadeVentaDetalle as $item)
                                @if ($item->u_nombre =='tonelada')
                                    <tr>
                                        ...
                                        <td align="right" style="width:80px">{{ $item->cantidad }}</td>
                                        <td style="width:80px">{{ $item->u_nombre }}</td>
                                        <td align="right" style="width:80px">{{ $item->Saldo }}</td>
