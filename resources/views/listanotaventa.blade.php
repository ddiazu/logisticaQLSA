            ...
            <div style="padding-bottom: 15px">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <a href="{{ asset('/') }}nuevanotaventa" class="btn btn-sm btn-primary">Crear Nota de Venta</a>
                        @endif
                    </div>
                    <div class="col-md-2">
                    ...
                    @foreach($listaNotasdeVenta as $item)
                        <tr>
                            ...
                            <td style="width:80px; text-align: right">
                               <b> {{ $item->CantidadNotaVenta - $item->CantidadPedidos }} </b>
                            </td>
                            <td>
                                @if($item->aprobada==1 and Session::get('grupoUsuario')=='C')
