						...
						@if ( Session::get('idPerfil')!='13' )
							...
							<li class="openable open">
								...
								<ul class="submenu">
									...
									@elseif ( Session::get('idPerfil')=='9' )
										<li><a href="{{ asset('/') }}guiasEnProceso"><span class="submenu-label">Guías en Proceso</span></a></li>
									@else
										<li><a href="{{ asset('/') }}listarNotasdeVenta"><span class="submenu-label">Notas de Venta</span></a></li>
							...
							<li class="openable open">
								...
								<ul class="submenu">
									...
									<li><a href="{{ asset('/') }}historicoPedidos""><span class="submenu-label">Histórico de Pedidos</span></a></li>
								</ul>								
							</li>
						    @if ( Session::get('grupoUsuario')!='CL' )
							<li class="openable open">
								...
								<ul class="submenu">
									...
									<li><a href="{{ asset('/') }}listadeObras"><span class="submenu-label">Obras</span></a></li>
									<li><a href="{{ asset('/') }}listaPlantas"><span class="submenu-label">Plantas</span></a></li>
